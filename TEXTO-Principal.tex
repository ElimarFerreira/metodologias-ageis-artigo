...
\documentclass[relatorio,baec]{unipampa}
...
\title{A Importância de Metodologias Ágeis no Desenvolvimento de Software.}

\author{Ferreira}{Elimar Viana}
...
\advisor[Prof\textsuperscript{a}.~Dr\textsuperscript{a}.]{Nunes}{Gerson Leiria}
...
%\textit{}\defesa{17}{dezembro}{2025}                      
% data da defesa - dia, mês e ano
...
\newpage
\input{beneficios-ageis}

\newpage
\input{tabela-comparativa}
